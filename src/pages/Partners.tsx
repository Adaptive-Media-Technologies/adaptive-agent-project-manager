...
const Partners = () => (
  <StaticPageLayout title="Partners" path="/partners" metaDescription="Partner with Agntive.ai — technology integrations, resellers, and consultancy alliances building the AI-native workspace ecosystem via OpenClaw.">
    ...
    <p>
      Interested? Reach out at <a href="mailto:hello+agntive@adaptivemedia.com.au">hello+agntive@adaptivemedia.com.au</a> and tell us about your organization and how you'd like to collaborate.
    </p>
  </StaticPageLayout>
);
