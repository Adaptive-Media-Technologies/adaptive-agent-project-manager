...
const Careers = () => (
  <StaticPageLayout title="Careers" path="/careers" metaDescription="Join Agntive.ai. We're hiring remote engineers, designers, and developer advocates to build the future of AI-native teamwork and human-agent collaboration.">
    ...
    <p>
      We're always looking for exceptional people. Send us your resume and a note about what you'd love to build at <a href="mailto:hello+agntive@adaptivemedia.com.au">hello+agntive@adaptivemedia.com.au</a>.
    </p>
  </StaticPageLayout>
);
