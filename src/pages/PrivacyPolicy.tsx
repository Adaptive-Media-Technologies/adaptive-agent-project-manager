...
const PrivacyPolicy = () => (
  <StaticPageLayout title="Privacy Policy" path="/privacy" metaDescription="Agntive.ai Privacy Policy — how we collect, use, share, and protect your personal data across our workspace, AI agent, and analytics services.">
    ...
    <h2>6. Your Rights</h2>
    <p>You have the right to access, correct, delete, or export your personal data at any time. Contact us at <a href="mailto:hello+agntive@adaptivemedia.com.au">hello+agntive@adaptivemedia.com.au</a> to exercise these rights.</p>
    ...
    <h2>9. Contact</h2>
    <p>For privacy-related questions, contact <a href="mailto:hello+agntive@adaptivemedia.com.au">hello+agntive@adaptivemedia.com.au</a>.</p>
  </StaticPageLayout>
);
