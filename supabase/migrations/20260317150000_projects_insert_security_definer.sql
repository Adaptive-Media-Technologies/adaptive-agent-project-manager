-- Fix: use SECURITY DEFINER so team-owner check is not blocked by RLS on teams/team_members.
-- Both team owners and team members can create projects for that team.
